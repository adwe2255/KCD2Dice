...
1. Add up to six dice from the `All Dice` table.
2. Remove individual dice with `x`, or clear the whole set.
3. The probability cards update from the exact selected set.
